"""
Test the demo path: TrendScout + ProductHunter, serial, cached.
...
from src.subagents import run_product_hunter, run_trend_scout
...
async def main() -> None:
    ...
    print(f"Running 2 sub-agents serially  category={category!r}, country={country}\n")
